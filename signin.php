...
<body>
  <div class="container">
    ...
    <div class="text-center mb-4">
      <img class="mb-4" src="picture/EazyMemo_logo.png" alt="" width="300" height="100">
    ...
    <div class="div-signin">
      <form class="form-signin" action="signin.php" method="post">
        ...
        <div class="form-label-group">
          <input type="email" id="inputEmail" class="form-control" placeholder="Email address" value="<?php if (!empty($cleans['password'])) {
                                                                                                        echo $cleans['password'];
                                                                                                      } ?>" required autofocus>
        </div>

        <div class="form-label-group">
          <input type="password" id="inputPassword" class="form-control" placeholder="Password" value="<?php if (!empty($cleans['password'])) {
                                                                                                          echo $cleans['password'];
                                                                                                        } ?>" required>
        </div>
      ...
      <button class="btn btn-outline-primary" type="submit" onclick="location.href='signup.php'">ユーザー登録</button>
    </div>
  </div>
  <br>
